...
A high-level `crypto_pwhash_*()` API is intentionally not defined yet, but may eventually use one of the BLAKE2b-based [Argon2](https://www.cryptolux.org/index.php/Argon) functions in its [final version](https://groups.google.com/forum/#!topic/crypto-competitions/3QNdmwBS98o).
