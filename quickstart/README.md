...
* If public verifiability is required, and the same message can be decrypted by multiple recipients, encrypt `(sender_id || H(message) || message`, then sign the ciphertext.
