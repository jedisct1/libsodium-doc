...
| Construction                   | Max number of encryptions | Max number of unsuccessful decryption attempts         | | :—————————– | :———————— | :—————————————————– | | AES256-GCM                     | 2^38                      | 2^85                                                   | | All ChaCha20-Poly1305 variants | 2^63                      | 2^63 (forgery with 2^-32 success requires \~2^77 bytes) |
